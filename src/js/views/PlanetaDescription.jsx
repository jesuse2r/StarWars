...
<div className="col-md-8">
  <div className="card-body">
    ...
    <div className="h4 pb-2 mb-4 text-danger border-bottom border-danger text d-flex gap-5 mt-4">

</div>
<div className="text d-flex mt-2 gap-5 text-danger m-3 justify-content-center">
<p>Name: {currentPlanet?.properties?.name}</p>
    <p>Birth Year: {currentPlanet?.properties?.climate}</p>
    <p>Gender: {currentPlanet?.properties?.population}</p>
    <p>Height: {currentPlanet?.properties?.orbital_period}</p>
    <p>Skin Color: {currentPlanet?.properties?.rotation_period}</p>
    <p>Eye Color: {currentPlanet?.properties?.diameter}</p>
    </div>
</div>
) : ( 
<>cargando</>
